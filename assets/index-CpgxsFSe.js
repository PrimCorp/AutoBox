...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function mo(e,t,n){let r=new Float32Array(eo),i=new U(0,1,0);return new Li({name:`SphericalGaussianBlur`,defines:{n:eo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:_o(),fragmentShader:`
	...
	`}var vo=class extends Wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new vi([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,a.nota&&(n+=`\nNotas: ${a.nota}`)):(n+=`- Base: ${h.name}\n`,n+=`- Medidas: ${h.medidas}\n`,n+=`- Salidas: ${r.outlets}\n`,n+=`- Sistema: ${r.sys===`arduino`?`Microcontrolador`:`PLC`}\n`,n+=`- Pantalla LCD: ${r.pantalla?`Si`:`No`}\n`,v&&(n+=`- Precio estimado: $${v}\n`),r.nota&&(n+=`\nNotas: ${r.nota}`)),window.open(`https://wa.me/+593963924706?text=${encodeURIComponent(n)}`,`_blank`)}let b={background:`rgba(255,255,255,0.04)`,border:`1px solid var(--borde)`,borderRadius:`8px`,padding:`10px 14px`,color:`var(--blanco)`,fontFamily:`'Exo 2', sans-serif`,fontSize:`0.85rem`,outline:`none`,width:`100%`},x={fontSize:`0.7rem`,letterSpacing:`2px`,textTransform:`uppercase`,color:`var(--gris)`,marginBottom:`8px`,display:`block`},S=(e,t,n)=>(0,p.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`1fr 1fr`,gap:`10px`},children:e.map(e=>(0,p.jsxs)(`div`,{onClick:()=>n(e),style:{border:`2px solid ${t===e?`var(--verde)`:`var(--borde)`}`,borderRadius:`10px`,padding:`14px`,cursor:`pointer`,background:t===e?`rgba(0,255,170,0.05)`:`rgba(255,255,255,0.02)`,transition:`all 0.3s`},children:[(0,p.jsx)(`div`,{style:{fontWeight:700,fontSize:`0.9rem`,marginBottom:`4px`},children:e===`arduino`?`⚡ Microcontrolador`:`🔧 PLC`}),(0,p.jsx)(`div`,{style:{fontSize:`0.68rem`,color:`var(--gris)`},children:e===`arduino`?`Sin garantía`:`Con garantía`})]},e))}),C=(e,t,n)=>(0,p.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`1fr 1fr`,gap:`10px`},children:[{val:!1,label:`❌ Sin pantalla`,desc:`Precio base`},{val:!0,label:`🖥️ Con pantalla`,desc:n===`arduino`?`Funcional · Cuenta monedas · +$${al.arduino}`:`Solo informativa · No cuenta monedas · +$${al.plc}`}].map(n=>(0,p.jsxs)(`div`,{onClick:()=>t(n.val),style:{border:`2px solid ${e===n.val?`var(--amarillo)`:`var(--borde)`}`,borderRadius:`10px`,padding:`14px`,cursor:`pointer`,background:e===n.val?`rgba(255,215,0,0.05)`:`rgba(255,255,255,0.02)`,transition:`all 0.3s`},children:[(0,p.jsx)(`div`,{style:{fontWeight:700,fontSize:`0.85rem`,marginBottom:`4px`},children:n.label}),(0,p.jsx)(`div`,{style:{color:`var(--gris)`,fontSize:`0.7rem`},children:n.desc})]},String(n.val)))});return(0,p.jsx)(`div`,{style:{position:`fixed`,inset:0,zIndex:1e3,background:`rgba(0,0,0,0.85)`,backdropFilter:`blur(10px)`,display:`flex`,alignItems:`center`,justifyContent:`center`,padding:`20px`,overflowY:`auto`},onClick:t=>t.target===t.currentTarget&&e(),children:(0,p.jsxs)(`div`,{style:{background:`var(--card)`,border:`1px solid var(--borde)`,borderRadius:`20px`,padding:`36px`,width:`100%`,maxWidth:`900px`,maxHeight:`90vh`,overflowY:`auto`,display:`grid`,gridTemplateColumns:`1fr 1fr`,gap:`32px`},children:[(0,p.jsxs)(`div`,{children:[(0,p.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`,marginBottom:`24px`},children:[(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`div`,{style:{fontSize:`0.68rem`,letterSpacing:`4px`,textTransform:`uppercase`,color:`var(--azul)`,marginBottom:`6px`},children:`Máquina personalizada`}),(0,p.jsx)(`div`,{style:{fontFamily:`'Black Ops One', cursive`,fontSize:`1.8rem`},children:`CONFIGURA`})]}),(0,p.jsx)(`button`,{onClick:e,style:{background:`rgba(255,255,255,0.05)`,border:`1px solid var(--borde)`,borderRadius:`8px`,padding:`8px 14px`,color:`var(--gris)`,cursor:`pointer`,fontFamily:`'Exo 2', sans-serif`,fontSize:`0.85rem`},children:`✕ Cerrar`})]}),(0,p.jsx)(`div`,{style:{marginBottom:`20px`},children:(0,p.jsx)(`button`,{onClick:()=>n(!t),style:{width:`100%`,padding:`14px`,background:t?`rgba(255,215,0,0.08)`:`rgba(255,255,255,0.03)`,border:`2px solid ${t?`var(--amarillo)`:`var(--borde)`}`,borderRadius:`10px`,cursor:`pointer`,color:t?`var(--amarillo)`:`var(--gris)`,fontFamily:`'Exo 2', sans-serif`,fontWeight:700,fontSize:`0.85rem`,letterSpacing:`1px`,transition:`all 0.3s`,display:`flex`,alignItems:`center`,justifyContent:`center`,gap:`8px`},children:t?`✓ Medidas personalizadas activadas`:`📐 ¿Necesitas otras medidas?`})}),t?(0,p.jsxs)(p.Fragment,{children:[(0,p.jsxs)(`div`,{style:{marginBottom:`20px`},children:[(0,p.jsx)(`label`,{style:x,children:`Medidas (cm)`}),(0,p.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`1fr 1fr 1fr`,gap:`10px`},children:[{key:`ancho`,label:`Ancho`},{key:`profundidad`,label:`Prof.`},{key:`alto`,label:`Alto`}].map(e=>(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`div`,{style:{fontSize:`0.65rem`,color:`var(--gris)`,marginBottom:`4px`},children:e.label}),(0,p.jsx)(`input`,{type:`number`,value:a[e.key],onChange:t=>m(e.key,t.target.value),placeholder:`cm`,style:b,min:10,max:500})]},e.key))})]}),(0,p.jsxs)(`div`,{style:{marginBottom:`20px`},children:[(0,p.jsx)(`label`,{style:x,children:`Número de salidas`}),(0,p.jsx)(`input`,{type:`number`,value:a.salidas,onChange:e=>m(`salidas`,e.target.value),placeholder:`¿Cuántas salidas necesitas?`,style:b,min:1,max:50})]}),(0,p.jsxs)(`div`,{style:{marginBottom:`20px`},children:[(0,p.jsx)(`label`,{style:x,children:`Sistema de control`}),S([`arduino`,`plc`],a.sys,e=>m(`sys`,e))]}),(0,p.jsxs)(`div`,{style:{marginBottom:`20px`},children:[(0,p.jsx)(`label`,{style:x,children:`Pantalla LCD`}),C(a.pantalla,e=>m(`pantalla`,e),a.sys)]}),(0,p.jsxs)(`div`,{style:{marginBottom:`20px`},children:[(0,p.jsx)(`label`,{style:x,children:`Notas adicionales`}),(0,p.jsx)(`textarea`,{value:a.nota,onChange:e=>m(`nota`,e.target.value),placeholder:`Describe cualquier requerimiento especial...`,rows:2,style:{...b,resize:`none`}})]})]}):(0,p.jsxs)(p.Fragment,{children:[(0,p.jsxs)(`div`,{style:{marginBottom:`20px`},children:[(0,p.jsx)(`label`,{style:x,children:`Modelo base`}),(0,p.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`1fr 1fr`,gap:`10px`},children:[`mini`,`estandar`].map(e=>(0,p.jsxs)(`div`,{onClick:()=>f(`base`,e),style:{border:`2px solid ${r.base===e?`var(--azul)`:`var(--borde)`}`,borderRadius:`10px`,padding:`14px`,cursor:`pointer`,background:r.base===e?`rgba(0,200,255,0.06)`:`rgba(255,255,255,0.02)`,transition:`all 0.3s`},children:[(0,p.jsx)(`div`,{style:{fontSize:`1.4rem`,marginBottom:`4px`},children:il[e].icon}),(0,p.jsx)(`div`,{style:{fontWeight:700,fontSize:`0.85rem`},children:il[e].name}),(0,p.jsx)(`div`,{style:{color:`var(--gris)`,fontSize:`0.7rem`,marginTop:`2px`},children:il[e].medidas})]},e))})]}),(0,p.jsxs)(`div`,{style:{marginBottom:`20px`},children:[(0,p.jsx)(`label`,{style:x,children:`Número de salidas`}),(0,p.jsx)(`div`,{style:{display:`flex`,flexWrap:`wrap`,gap:`8px`},children:h.outlets.map(e=>(0,p.jsx)(`button`,{onClick:()=>f(`outlets`,e),style:{flex:`1`,minWidth:`60px`,padding:`10px 8px`,border:`2px solid ${r.outlets===e?`var(--azul)`:`var(--borde)`}`,borderRadius:`8px`,cursor:`pointer`,background:r.outlets===e?`rgba(0,200,255,0.08)`:`rgba(255,255,255,0.02)`,color:r.outlets===e?`var(--azul)`:`var(--blanco)`,fontFamily:`'Exo 2', sans-serif`,fontWeight:700,fontSize:`0.82rem`},children:e},e))})]}),(0,p.jsxs)(`div`,{style:{marginBottom:`20px`},children:[(0,p.jsx)(`label`,{style:x,children:`Sistema de control`}),S(h.systems,r.sys,e=>f(`sys`,e))]}),(0,p.jsxs)(`div`,{style:{marginBottom:`20px`},children:[(0,p.jsx)(`label`,{style:x,children:`Pantalla LCD`}),C(r.pantalla,e=>f(`pantalla`,e),r.sys)]}),(0,p.jsxs)(`div`,{style:{marginBottom:`20px`},children:[(0,p.jsx)(`label`,{style:x,children:`Notas adicionales`}),(0,p.jsx)(`textarea`,{value:r.nota,onChange:e=>f(`nota`,e.target.value),placeholder:`Describe cualquier detalle adicional...`,rows:2,style:{...b,resize:`none`}})]})]}),(0,p.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`10px`},children:[(0,p.jsx)(`input`,{type:`text`,placeholder:`Tu nombre`,value:s,onChange:e=>c(e.target.value),style:b}),(0,p.jsx)(`input`,{type:`tel`,placeholder:`Tu teléfono (opcional)`,value:l,onChange:e=>u(e.target.value),style:b}),(0,p.jsxs)(`button`,{onClick:y,style:{background:`linear-gradient(120deg, #25D366, #128C7E)`,color:`white`,padding:`15px`,border:`none`,borderRadius:`8px`,fontFamily:`'Exo 2', sans-serif`,fontWeight:700,fontSize:`0.88rem`,cursor:`pointer`,display:`flex`,alignItems:`center`,justifyContent:`center`,gap:`9px`,width:`100%`,letterSpacing:`1px`},children:[(0,p.jsx)(`svg`,{width:`18`,height:`18`,viewBox:`0 0 24 24`,fill:`currentColor`,children:(0,p.jsx)(`path`,{d:`M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z`})}),`Enviar cotización por WhatsApp`]})]})]}),(0,p.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`20px`},children:[(0,p.jsx)(`div`,{style:{fontFamily:`'Black Ops One', cursive`,fontSize:`1rem`,letterSpacing:`2px`,color:`var(--azul)`},children:`VISTA PREVIA`}),(0,p.jsx)(nl,{outlets:t?parseInt(a.salidas)||1:r.outlets,modelType:t?`estandar`:r.base,height:300,small:!0,showLCD:t?a.pantalla:r.pantalla}),(0,p.jsxs)(`div`,{style:{background:`rgba(255,255,255,0.02)`,border:`1px solid var(--borde)`,borderRadius:`12px`,padding:`20px`},children:[(0,p.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`10px`,marginBottom:`16px`},children:t?(0,p.jsx)(p.Fragment,{children:[{label:`Ancho`,value:a.ancho?`${a.ancho} cm`:`—`},{label:`Profundidad`,value:a.profundidad?`${a.profundidad} cm`:`—`},{label:`Alto`,value:a.alto?`${a.alto} cm`:`—`},{label:`Salidas`,value:a.salidas||`—`},{label:`Sistema`,value:a.sys===`arduino`?`Microcontrolador`:`PLC`},{label:`Pantalla`,value:a.pantalla?`Sí`:`No`}].map(e=>(0,p.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,fontSize:`0.82rem`},children:[(0,p.jsx)(`span`,{style:{color:`var(--gris)`},children:e.label}),(0,p.jsx)(`span`,{style:{fontWeight:700},children:e.value})]},e.label))}):(0,p.jsx)(p.Fragment,{children:[{label:`Base`,value:h.name},{label:`Medidas`,value:h.medidas},{label:`Salidas`,value:r.outlets},{label:`Sistema`,value:r.sys===`arduino`?`Microcontrolador`:`PLC`},{label:`Pantalla`,value:r.pantalla?`Sí (+$${r.sys===`arduino`?al.arduino:al.plc})`:`No`}].map(e=>(0,p.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,fontSize:`0.82rem`},children:[(0,p.jsx)(`span`,{style:{color:`var(--gris)`},children:e.label}),(0,p.jsx)(`span`,{style:{fontWeight:700},children:e.value})]},e.label))})}),(0,p.jsx)(`div`,{style:{height:`1px`,background:`var(--borde)`,margin:`14px 0`}}),(0,p.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`baseline`},children:[(0,p.jsx)(`span`,{style:{fontSize:`0.7rem`,letterSpacing:`2px`,textTransform:`uppercase`,color:`var(--gris)`},children:`Total estimado`}),(0,p.jsx)(`span`,{style:{fontFamily:`'Black Ops One', cursive`,fontSize:`2rem`,background:`linear-gradient(120deg, var(--azul), var(--verde))`,WebkitBackgroundClip:`text`,WebkitTextFillColor:`transparent`},children:t?`A consultar`:v===null?`—`:`$${v}`})]})]})]})]})})}function ll(){let[e,t]=(0,d.useState)({model:null,outlets:null,sys:null}),[n,r]=(0,d.useState)(``),[i,a]=(0,d.useState)(``),[o,s]=(0,d.useState)(``),[c,l]=(0,d.useState)(!1);function u(e){t({model:e,outlets:null,sys:null})}function f(e){t(t=>({...t,outlets:e,sys:null}))}function m(e){t(t=>({...t,sys:e}))}let h=e.model?il[e.model]:null,g=e.model&&e.outlets?il[e.model].prices[e.outlets]:null;return(0,p.jsxs)(`section`,{className:`section`,id:`configurador`,children:[(0,p.jsx)(`div`,{className:`sec-label`,children:`Cotizador interactivo`}),(0,p.jsxs)(`h2`,{className:`sec-title`,children:[`Configura tu`,(0,p.jsx)(`br`,{}),`Máquina Ideal`]}),(0,p.jsx)(`p`,{className:`sec-sub`,children:`Elige opciones, visualiza en 3D cómo queda y recibe tu cotización por WhatsApp.`}),(0,p.jsxs)(`div`,{className:`config-grid`,children:[(0,p.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`18px`},children:[(0,p.jsx)(ul,{number:1,title:`Modelo`,sub:`Elige según la cantidad de productos`,children:(0,p.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`1fr 1fr`,gap:`10px`},children:[Object.entries(il).filter(([e])=>e!==`premium`).map(([t,n])=>(0,p.jsxs)(`div`,{onClick:()=>u(t),style:{background:`rgba(255,255,255,0.02)`,border:`2px solid ${e.model===t?`var(--azul)`:`var(--borde)`}`,borderRadius:`10px`,padding:`16px 14px`,cursor:`pointer`,transition:`all 0.3s`,position:`relative`,...e.model===t&&{background:`rgba(0,200,255,0.06)`,boxShadow:`0 0 20px rgba(0,200,255,0.1)`}},children:[e.model===t&&(0,p.jsx)(`div`,{style:{position:`absolute`,top:8,right:8,width:18,height:18,borderRadius:`50%`,background:`var(--azul)`,color:`var(--negro)`,fontSize:`0.6rem`,fontWeight:900,display:`flex`,alignItems:`center`,justifyContent:`center`},children:`✓`}),(0,p.jsx)(`div`,{style:{fontSize:`1.6rem`,marginBottom:`6px`},children:n.icon}),(0,p.jsx)(`div`,{style:{fontWeight:700,fontSize:`0.85rem`},children:n.name}),(0,p.jsxs)(`div`,{style:{color:`var(--gris)`,fontSize:`0.7rem`,marginTop:`3px`},children:[n.outlets[0],`-`,n.outlets[n.outlets.length-1],` salidas · `,n.medidas]})]},t)),(0,p.jsxs)(`div`,{onClick:()=>l(!0),style:{background:`rgba(255,215,0,0.04)`,border:`2px solid rgba(255,215,0,0.3)`,borderRadius:`10px`,padding:`16px 14px`,cursor:`pointer`,transition:`all 0.3s`,gridColumn:`1 / -1`},onMouseEnter:e=>e.currentTarget.style.borderColor=`var(--amarillo)`,onMouseLeave:e=>e.currentTarget.style.borderColor=`rgba(255,215,0,0.3)`,children:[(0,p.jsx)(`div`,{style:{fontSize:`1.6rem`,marginBottom:`6px`},children:`🏭`}),(0,p.jsx)(`div`,{style:{fontWeight:700,fontSize:`0.85rem`,color:`var(--amarillo)`},children:`PERSONALIZADA`}),(0,p.jsx)(`div`,{style:{color:`var(--gris)`,fontSize:`0.7rem`,marginTop:`3px`},children:`Medidas custom · Pantalla opcional · Configura a tu medida`})]})]})}),(0,p.jsx)(ul,{number:2,title:`Salidas de dispensado`,sub:`Cada salida es un producto o precio diferente`,children:h?(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(`div`,{style:{display:`flex`,flexWrap:`wrap`,gap:`8px`},children:h.outlets.map(t=>(0,p.jsxs)(`button`,{onClick:()=>f(t),style:{flex:`1`,minWidth:`70px`,padding:`12px 8px`,border:`2px solid ${e.outlets===t?`var(--azul)`:`var(--borde)`}`,borderRadius:`8px`,cursor:`pointer`,textAlign:`center`,background:e.outlets===t?`rgba(0,200,255,0.08)`:`rgba(255,255,255,0.02)`,color:e.outlets===t?`var(--azul)`:`var(--blanco)`,fontFamily:`'Exo 2', sans-serif`,fontWeight:700,fontSize:`0.82rem`,transition:`all 0.3s`},children:[t,` `,t===1?`salida`:`salidas`]},t))}),e.model===`mini`&&(0,p.jsx)(`div`,{style:{fontSize:`0.72rem`,color:`var(--naranja)`,marginTop:`10px`},children:`⚠️ El modelo MINI soporta máximo 2 salidas.`})]}):(0,p.jsx)(`div`,{style:{fontSize:`0.85rem`,color:`var(--gris)`,fontStyle:`italic`},children:`Primero selecciona un modelo`})}),(0,p.jsx)(ul,{number:3,title:`Sistema de control`,sub:`Microcontrolador más económico · PLC más robusto y con garantía`,children:e.outlets?(0,p.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`1fr 1fr`,gap:`10px`},children:h.systems.map(t=>{let n=t===`arduino`?g?.arduino:g?.plc,r=n==null;return(0,p.jsxs)(`div`,{onClick:()=>!r&&m(t),style:{border:`2px solid ${e.sys===t?`var(--verde)`:`var(--borde)`}`,borderRadius:`10px`,padding:`18px`,cursor:r?`not-allowed`:`pointer`,background:e.sys===t?`rgba(0,255,170,0.05)`:`rgba(255,255,255,0.02)`,opacity:r?.25:1,transition:`all 0.3s`,...e.sys===t&&{boxShadow:`0 0 20px rgba(0,255,170,0.08)`}},children:[(0,p.jsx)(`div`,{style:{fontWeight:700,fontSize:`0.95rem`,marginBottom:`6px`},children:t===`arduino`?`⚡ Microcontrolador`:`🔧 PLC`}),(0,p.jsx)(`div`,{style:{fontFamily:`'Black Ops One', cursive`,fontSize:`1.4rem`,color:`var(--verde)`,lineHeight:1},children:r?`N/D`:`$${n}`}),(0,p.jsx)(`div`,{style:{fontSize:`0.68rem`,color:`var(--gris)`,letterSpacing:`1px`,marginTop:`4px`},children:t===`arduino`?g?.arduino===550?`Garantía 6 meses`:`Sin garantía`:`Con garantía`})]},t)})}):(0,p.jsx)(`div`,{style:{fontSize:`0.85rem`,color:`var(--gris)`,fontStyle:`italic`},children:`Primero selecciona las salidas`})})]}),(0,p.jsx)(sl,{state:e,clientName:n,clientPhone:i,clientMsg:o,onNameChange:r,onPhoneChange:a,onMsgChange:s})]}),c&&(0,p.jsx)(cl,{onClose:()=>l(!1)})]})}function ul({number:e,title:t,sub:n,children:r}){return(0,p.jsxs)(`div`,{style:{background:`var(--card)`,border:`1px solid var(--borde)`,borderRadius:`14px`,padding:`26px`},children:[(0,p.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`12px`,marginBottom:`20px`},children:[(0,p.jsx)(`div`,{style:{width:34,height:34,borderRadius:`50%`,flexShrink:0,background:`linear-gradient(120deg, var(--azul), var(--verde))`,color:`var(--negro)`,display:`flex`,alignItems:`center`,justifyContent:`center`,fontWeight:900,fontSize:`0.82rem`},children:e}),(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`div`,{style:{fontWeight:700,fontSize:`0.95rem`},children:t}),(0,p.jsx)(`div`,{style:{color:`var(--gris)`,fontSize:`0.75rem`,marginTop:`2px`},children:n})]})]}),r]})}var dl=[`WhatsApp Image 2026-04-02 at 13.42.45.jpeg`,`WhatsApp Image 2026-04-02 at 13.42.45 (1).jpeg`,`WhatsApp Image 2026-04-02 at 13.42.45 (2).jpeg`,`WhatsApp Image 2026-04-02 at 13.42.46.jpeg`,`WhatsApp Image 2026-04-02 at 13.42.47.jpeg`,`WhatsApp Image 2026-04-02 at 13.42.47 (1).jpeg`,`WhatsApp Image 2026-04-02 at 13.42.47 (2).jpeg`,`WhatsApp Image 2026-04-02 at 13.42.47 (3).jpeg`,`WhatsApp Image 2026-04-02 at 13.42.48.jpeg`,`WhatsApp Image 2026-04-02 at 13.42.49.jpeg`,`WhatsApp Image 2026-04-02 at 13.42.49 (1).jpeg`,`WhatsApp Image 2026-04-02 at 13.42.49 (2).jpeg`,`WhatsApp Image 2026-04-02 at 13.42.49 (3).jpeg`,`WhatsApp Image 2026-04-02 at 13.42.49 (4).jpeg`,`WhatsApp Image 2026-04-02 at 13.42.50.jpeg`,`WhatsApp Image 2026-04-02 at 13.42.50 (1).jpeg`,`WhatsApp Image 2026-04-02 at 13.42.50 (2).jpeg`];function fl(){let[e,t]=(0,d.useState)(null);return(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(`div`,{style:{height:`1px`,background:`var(--borde)`,position:`relative`,zIndex:1}}),(0,p.jsxs)(`section`,{className:`section`,id:`galeria`,children:[(0,p.jsx)(`div`,{className:`sec-label`,children:`Trabajos realizados`}),(0,p.jsx)(`h2`,{className:`sec-title`,children:`Nuestra Galería`}),(0,p.jsx)(`p`,{className:`sec-sub`,children:`Mira algunas de las máquinas que hemos fabricado para nuestros clientes.`}),(0,p.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(auto-fill, minmax(200px, 1fr))`,gap:`12px`},children:dl.map((e,n)=>(0,p.jsx)(`div`,{onClick:()=>t(e),style:{cursor:`pointer`,borderRadius:`10px`,overflow:`hidden`,border:`1px solid var(--borde)`,boxShadow:`0 2px 8px rgba(0,0,0,0.1)`,transition:`all 0.3s`,aspectRatio:`1`},onMouseEnter:e=>{e.currentTarget.style.transform=`scale(1.03)`,e.currentTarget.style.boxShadow=`0 8px 24px rgba(0,0,0,0.2)`},onMouseLeave:e=>{e.currentTarget.style.transform=`scale(1)`,e.currentTarget.style.boxShadow=`0 2px 8px rgba(0,0,0,0.1)`},children:(0,p.jsx)(`img`,{src:`/AutoBox/fotos/${encodeURIComponent(e)}`,alt:`Máquina AUTOBOX ${n+1}`,style:{width:`100%`,height:`100%`,objectFit:`cover`}})},n))})]}),e&&(0,p.jsx)(`div`,{onClick:()=>t(null),style:{position:`fixed`,inset:0,zIndex:1e3,background:`rgba(0,0,0,0.9)`,display:`flex`,alignItems:`center`,justifyContent:`center`,padding:`20px`,cursor:`zoom-out`},children:(0,p.jsxs)(`div`,{style:{position:`relative`,maxWidth:`90vw`,maxHeight:`90vh`},children:[(0,p.jsx)(`img`,{src:`/AutoBox/fotos/${encodeURIComponent(e)}`,alt:`Foto ampliada`,style:{maxWidth:`90vw`,maxHeight:`90vh`,borderRadius:`12px`,objectFit:`contain`}}),(0,p.jsx)(`button`,{onClick:()=>t(null),style:{position:`absolute`,top:-16,right:-16,width:36,height:36,borderRadius:`50%`,background:`var(--azul)`,color:`white`,border:`none`,cursor:`pointer`,fontSize:`1rem`,fontWeight:900,display:`flex`,alignItems:`center`,justifyContent:`center`},children:`✕`})]})})]})}function pl(){return(0,p.jsx)(`div`,{className:`stats-grid`,style:{position:`relative`,zIndex:1},children:[{n:`2`,l:`Modelos`},{n:`2`,l:`Sistemas`},{n:`$350`,l:`Desde`},{n:`24H`,l:`Atención`}].map(e=>(0,p.jsxs)(`div`,{className:`stat-item`,children:[(0,p.jsx)(`div`,{className:`stat-num`,children:e.n}),(0,p.jsx)(`div`,{className:`stat-label`,children:e.l})]},e.l))})}function ml(){return(0,p.jsxs)(`footer`,{style:{position:`relative`,zIndex:1,borderTop:`1px solid var(--borde)`,padding:`40px 48px`,textAlign:`center`},children:[(0,p.jsx)(`div`,{style:{fontFamily:`'Black Ops One', cursive`,fontSize:`1.4rem`,letterSpacing:`4px`,background:`linear-gradient(120deg, var(--azul), var(--verde))`,WebkitBackgroundClip:`text`,WebkitTextFillColor:`transparent`,marginBottom:`8px`},children:`AUTOBOX`}),(0,p.jsx)(`div`,{style:{color:`var(--gris)`,fontSize:`0.75rem`,letterSpacing:`1px`},children:`AutoBox-Máquinas dispensadoras Automaticas-QUITO ECUADOR`})]})}function hl(){return(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(`div`,{className:`bg-layer`}),(0,p.jsx)(`div`,{className:`grid-layer`}),(0,p.jsx)(m,{}),(0,p.jsx)(rl,{}),(0,p.jsx)(pl,{}),(0,p.jsx)(ol,{}),(0,p.jsx)(ll,{}),(0,p.jsx)(fl,{}),(0,p.jsx)(ml,{})]})}(0,f.createRoot)(document.getElementById(`root`)).render((0,p.jsx)(d.StrictMode,{children:(0,p.jsx)(hl,{})}));